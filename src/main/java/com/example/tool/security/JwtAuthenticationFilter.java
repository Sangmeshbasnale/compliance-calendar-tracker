...
/**
 * Intercepts every HTTP request to check for a valid JWT in the
 * {@code Authorization: Bearer <token>} header. If valid, the
 * authenticated user is placed into the {@link SecurityContextHolder}.
 */
@Component
